...
const scriptsInEvents = {
		...
		async Es_mainmenu_Event2_Act1(runtime, localVars)
		{
			if (Cookies.get('fauna-auth')) {
		...
		async Es_mainmenu_Event3_Act5(runtime, localVars)
		{
			await fetch('/api/FireInit', {
				...
				runtime.objects.highScoreText.getFirstInstance().text =`[outline=#000000]HIGH SCORE: ${runtime.globalVars.FireHit}[/outline]`;
			})
		},
